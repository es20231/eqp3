...
describe('Home Component', () => {
  ...
  test('testando a submissão do login', async () => {
    ...
    expect(useApi().login).toHaveBeenCalledWith('john.doe', 'password123');
  ...
  //   // Simular a função login da API retornando uma promise rejeitada
  //   useApi.mockReturnValue({
